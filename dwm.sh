...
sudo pacman -S --noconfirm acpilight xorg sx simplescreenrecorder ttf-bitstream-vera ttf-dejavu ttf-liberation ttf-devicons ttf-linux-libertine noto-fonts tex-gyre-fonts ttf-jetbrains-mono adobe-source-code-pro-fonts noto-fonts-cjk noto-fonts-emoji zathura zathura-pdf-mupdf calcurse dash dunst exa feh flameshot inkscape lxappearance-gtk3 lxsession-gtk3 mpc mpd mpv ncmpcpp wmctrl lazygit newsboat redshift rofi rofi-pass trash-cli interception-dual-function-keys
...
cd paru
makepkg -si
paru -S --noconfirm beautyline brave-bin dragon-drag-and-drop gotop-bin lf mpd-notification-git mutt-wizard nerd-fonts-jetbrains-mono nerd-fonts-monoki pfetch zramd ttf-twemoji libxft-bgra-git
